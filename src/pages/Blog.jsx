...
const Blog = () => {
	return (
		<div className='flex flex-col mt-8'>
			<h2 className='text-3xl text-center font-semibold' data-aos='fade-down' data-aos-delay='800'>
				Blogs
			</h2>
				...
				<div
					...
					<div className='container flex flex-col lg:flex-row bg-gray-50 rounded-2xl pb-6 lg:pb-0'>
						<div className='flex flex-col p-6 lg:p-10 lg:w-3/5'>
							...
							<p className='flex-1 pt-2 text-sm lg:text-lg'>
								Uncover the magic of private island living with secluded beaches, crystal-clear waters, and exclusive retreats that
								offer ultimate privacy and tranquility.
							</p>
							<div className='flex items-center justify-between pt-2 mt-2'>
								<div className='flex space-x-2'>
